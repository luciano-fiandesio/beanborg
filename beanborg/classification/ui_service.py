...
class UIService:
    @staticmethod
    def display_transaction(tx, top_labels: List[str], top_probs: List[float], chatgpt_prediction: str):
        console = Console()
        console.clear()
        ...
        predictions_content.append(f"[bold cyan]4.[/] ChatGPT: [cyan]{chatgpt_prediction}[/]")
